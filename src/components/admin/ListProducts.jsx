...
const ListProducts = () => {
    ...
    const [deleteProduct, { isLoading: isDeleteLoanding, error: deleteError, isSuccess }] = useDeleteProductMutation();
    ...
    const setProducts = () => {
        ...
        data?.products?.forEach((product) => {
            products.rows.push({
                ...
                <button className="btn btn-outline-danger ms-2" onClick={() => deleteProductHandler(product?._id)} disabled={isDeleteLoanding}>
